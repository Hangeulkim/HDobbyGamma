...
internal static class UiText
{
    private static readonly IReadOnlyDictionary<TextId, (string Korean, string English)> Catalog =
        new Dictionary<TextId, (string, string)>
        {
            ...
            [TextId.TargetProgramAccessible] = ("마우스를 가둘 프로그램 실행 파일", "Executable whose window will confine the mouse"),
            [TextId.ChooseProgram] = ("찾아보기", "Browse"),
            ...
            [TextId.ConfineRequiresProgram] = ("대상 프로그램의 실행 파일(.exe)을 먼저 선택하세요.", "Choose the target program's .exe file first."),
            [TextId.ConfineFailed] = ("마우스를 가두지 못했습니다: {0}", "Could not confine the mouse: {0}"),
            [TextId.ConfineEnabled] = ("대상 프로그램 창이 활성화되면 마우스를 가둡니다. Ctrl+Alt+L로 해제할 수 있습니다.", "The mouse will be confined while the target window is active. Press Ctrl+Alt+L to release it."),
            ...
            [TextId.ConfineReleased] = ("마우스 가두기를 해제했습니다.", "Mouse confinement released."),
            [TextId.TrayReleaseCursor] = ("마우스 가두기 해제", "Release mouse confinement"),
